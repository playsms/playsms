...
DROP TABLE IF EXISTS `playsms_gatewayTelnyx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `playsms_gatewayTelnyx` (
  `c_timestamp` bigint(20) NOT NULL DEFAULT '0',
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `local_smslog_id` int(11) NOT NULL DEFAULT '0',
  `remote_smslog_id` varchar(40) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `playsms_gatewayTelnyx`
--

LOCK TABLES `playsms_gatewayTelnyx` WRITE;
/*!40000 ALTER TABLE `playsms_gatewayTelnyx` DISABLE KEYS */;
/*!40000 ALTER TABLE `playsms_gatewayTelnyx` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `playsms_gatewayTelnyx_config`
--

DROP TABLE IF EXISTS `playsms_gatewayTelnyx_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `playsms_gatewayTelnyx_config` (
  `c_timestamp` bigint(20) NOT NULL DEFAULT '0',
  `cfg_name` varchar(20) NOT NULL DEFAULT 'telnyx',
  `cfg_url` varchar(250) DEFAULT NULL,
...
--
-- Dumping data for table `playsms_gatewayTelnyx_config`
--

LOCK TABLES `playsms_gatewayTelnyx_config` WRITE;
/*!40000 ALTER TABLE `playsms_gatewayTelnyx_config` DISABLE KEYS */;
INSERT INTO `playsms_gatewayTelnyx_config` VALUES (0,'telnyx','https://sms.telnyx.com','http://localhost/playsms/plugin/gateway/telnyx/callback.php','87654321','+10000000000','');
/*!40000 ALTER TABLE `playsms_gatewayTelnyx_config` ENABLE KEYS */;
UNLOCK TABLES;
