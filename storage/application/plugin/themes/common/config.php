...
$icon_config = array(
	...
	'remove' => "<span class='playsms-icon fas fa-trash' alt='" . _('Remove') . "' title='" . _('Remove') . "'></span>",
	'move' => "<span class='playsms-icon fas fa-arrows-alt' alt='" . _('Move') . "' title='" . _('Move') . "'></span>",
	...
	'user_remove' => "<span class='playsms-icon fas fa-user-minus' alt='" . _('Remove') . "' title='" . _('Remove') . "'></span>",
	'user_move' => "<span class='playsms-icon fas fa-suitcase-rolling' alt='" . _('Move') . "' title='" . _('Move') . "'></span>",
	...
	'ban' => "<span class='playsms-icon fas fa-ban' alt='" . _('Ban') . "' title='" . _('Ban') . "'></span>",
	'unban' => "<span class='playsms-icon fas fa-thumbs-up' alt='" . _('Unban') . "' title='" . _('Unban') . "'></span>",
	'idle' => "<span class='playsms-icon fas fa-clock' alt='" . _('Idle') . "' title='" . _('Idle') . "'></span>",
	...
	'sms' => "<span class='playsms-icon fas fa-comment-alt' alt='" . _('SMS') . "' title='" . _('SMS') . "'></span>",
	'message' => "<span class='playsms-icon fas fa-comment-alt' alt='" . _('Message') . "' title='" . _('Message') . "'></span>",
	...
	'rate' => "<span class='playsms-icon fas fa-table' alt='" . _('Rate') . "' title='" . _('Rate') . "'></span>",
	'charge' => "<span class='playsms-icon fas fa-file-invoice-dollar' alt='" . _('Charge') . "' title='" . _('Charge') . "'></span>",
	'card' => "<span class='playsms-icon fas fa-file-alt' alt='" . _('Card') . "' title='" . _('Card') . "'></span>",
	'ratecard' => "<span class='playsms-icon fas fa-file-alt' alt='" . _('Ratecard') . "' title='" . _('Ratecard') . "'></span>",
);
