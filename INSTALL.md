...
This document explains about how to install and setup playSMS version **1.4.4-beta**
...
As of playSMS version **1.4.4-beta** the first time username is **admin** and password is **changemeplease**
