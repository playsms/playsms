...
$icon_enable = "<img src=\"".$http_path['themes']."/".$themes_module."/images/enable.gif\" alt=\""._('Enable')."\" title=\""._('Enable')."\" border=0>";
$icon_disable = "<img src=\"".$http_path['themes']."/".$themes_module."/images/disable.gif\" alt=\""._('Disable')."\" title=\""._('Disable')."\" border=0>";
