...
<div id="wrap">
  ...
  <div id="top">
    <img alt="top" src="<?php echo $http_path['themes']; ?>/<?php echo $themes_module; ?>/images/top.gif">
  </div>

  <div id="header">

    <div class="headerleft">
      <a href="<?php echo $http_path['base']; ?>">
        <!--img src="<?php echo $http_path['themes']; ?>/<?php echo $themes_module; ?>/images/your-logo.png" alt="Your logo" /-->
      </a>
    </div>
