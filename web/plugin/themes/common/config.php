...
$icon_config = array(
	...
	'login_as' => "<span class='playsms-icon fas fa-sign-in' alt='" . _('Login as') . "' title='" . _('Login as') . "'></span>",
	'login' => "<span class='playsms-icon fas fa-sign-in' alt='" . _('Login') . "' title='" . _('Login') . "'></span>",
	'logout' => "<span class='playsms-icon fas fa-sign-out' alt='" . _('Logout') . "' title='" . _('Logout') . "'></span>",
