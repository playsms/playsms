...
<TR>
    ...
    <TR>
        <TD COLSPAN=3><a href="<?php echo $http_path['base']; ?>"><IMG SRC="<?php echo $http_path['themes']; ?>/<?php echo $themes_module; ?>/images/login_00.gif" WIDTH=370 border=0></a></TD>
    </TR>
    <TR>
        <TD WIDTH=7 background="<?php echo $http_path['themes']; ?>/<?php echo $themes_module; ?>/images/login_02.gif"><IMG SRC="<?php echo $http_path['themes']; ?>/<?php echo $themes_module; ?>/images/login_02.gif" WIDTH=7 HEIGHT=16></TD>
    ...
    <tr>
        <td width="140" align="right"><?php echo _('Mobile'); ?> &nbsp; </td>
        <td>&nbsp;<input type=text name=mobile maxlength=100 size=20></td>
    </tr>
    <tr>
...
<tr>
    <td>&nbsp;</td>
    <td>&nbsp;<input type=submit class=button value="<?php echo _('Register an account'); ?>"></td>
</tr>
</form>          
</table>
...
<TR>
    <TD COLSPAN=3><a href="http://playsms.org"><IMG SRC="<?php echo $http_path['themes']; ?>/<?php echo $themes_module; ?>/images/powered_by_playsms.gif" WIDTH=370 border=0></a></TD>
</TR>
</TABLE>
</td>
</TR>
