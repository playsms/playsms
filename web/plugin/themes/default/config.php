...
/*
 * $themes_config['default']['icon'] = array( 'edit' => "<span class='playsms-icon fa fa-pencil' alt='"._('Edit')."' title='"._('Edit')."'></span>", 'delete' => "<span class='playsms-icon fa fa-trash' alt='"._('Delete')."' title='"._('Delete')."'></span>", );
 */
