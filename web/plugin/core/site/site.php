...
switch (_OP_) {
	case "site_config":
		...
		$options['enable_register'] = _options([_('yes') => 1, _('no') => 0], $site_config['enable_register']);
		
		// enable forgot yes-no option
		$selected = ($site_config['enable_forgot'] ? _('yes') : _('no'));
		$options['enable_forgot'] = _options([_('yes') => 1, _('no') => 0], $site_config['enable_forgot']);
		
		// enable logo yes-no option
		$options['enable_logo'] = _options([_('yes') => 1, _('no') => 0], $site_config['enable_logo']);
		
		// enable logo to replace main website title yes-no option
		$options['logo_replace_title'] = _options([_('yes') => 1, _('no') => 0], $site_config['logo_replace_title']);
