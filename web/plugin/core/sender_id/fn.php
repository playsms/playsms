...
function sender_id_default_get($uid)
{
	...
	$sender_id = isset($data[0]['sender']) ? $data[0]['sender'] : '';
 ...
 * @param int $isdefault Flag 1 for default sender ID
 * @param int $isapproved Flag 1 for approved sender ID
 * @return bool true when new sender ID has been added
 */
 ...
 * @param int $isdefault Flag 1 for default sender ID
 * @param int $isapproved Flag 1 for approved sender ID
 * @return bool true when new sender ID has been updated
 */
