...
switch (_OP_) {
	case "manage" :
		...
		$content .= "
			...
			<tr>
				<td>" . _ ( 'Password' ) . "</td><td><input type=password maxlength=30 name=up_password value=\"" . $plugin_config['bulksms']['password'] . "\"> " . _hint ( _ ( 'Fill to change the password' ) ) . "</td>
			</tr>
			<tr>
	...
	case "manage_save" :
		...
		if (@dba_affected_rows ( $db_query )) {
			...
			$_SESSION['dialog']['error'][] = _ ( 'Error: configurations not saved' );
		}
