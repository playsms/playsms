...
switch ($op)
{
	...
	<table width=100% cellpadding=1 cellspacing=2 border=0>
	    ...
	    <tr>
		<td>"._('Module sender number')."</td><td>:</td><td><input type=text size=11 maxlength=11 name=up_global_sender value=\"".$uplink_param['global_sender']."\"> ("._('Max. 16 numeric or 11 alphanumeric char. empty to disable').")</td>
	    </tr>
	    <tr>
