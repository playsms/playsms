...
if ($db_row = dba_fetch_array($db_result)) {
	...
	$plugin_config['nexmo']['url'] = ($db_row['cfg_url'] ?: 'https://rest.nexmo.com/sms/json');
...
// smsc configuration
$plugin_config['nexmo']['_smsc_config_'] = ['api_key' => _('API key'), 'api_secret' => _('API secret'), 'module_sender' => _('Module sender ID'), 'datetime_timezone' => _('Module timezone')];
