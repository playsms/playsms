...
if ($gw == $plugin_config['clickatell']['name']) {
...
switch (_OP_) {
	case "manage" :
		...
		$content .= "
			...
			<tr>
				<td>" . _ ( 'API ID' ) . "</td><td><input type=text size=30 maxlength=20 name=up_api_id value=\"" . $plugin_config['clickatell']['api_id'] . "\"></td>
			</tr>
			<tr>
				<td>" . _ ( 'Username' ) . "</td><td><input type=text size=30 maxlength=30 name=up_username value=\"" . $plugin_config['clickatell']['username'] . "\"></td>
			</tr>
			<tr>
			...
			<tr>
				<td>" . _ ( 'Module sender ID' ) . "</td><td><input type=text size=30 maxlength=16 name=up_sender value=\"" . $plugin_config['clickatell']['global_sender'] . "\"> " . _hint ( _ ( 'Max. 16 numeric or 11 alphanumeric char. empty to disable' ) ) . "</td>
			</tr>
			<tr>
			...
			<tr>
				<td>" . _ ( 'Clickatell API URL' ) . "</td><td><input type=text size=30 maxlength=250 name=up_send_url value=\"" . $plugin_config['clickatell']['send_url'] . "\"> " . _hint ( _ ( 'No trailing slash' ) . " \"/\"" ) . "</td>
			</tr>
			<tr>
				<td>" . _ ( 'Additional URL parameter' ) . "</td><td><input type=text size=30 maxlength=250 name=up_additional_param value=\"" . $plugin_config['clickatell']['additional_param'] . "\"></td>
			</tr>
			</table>
