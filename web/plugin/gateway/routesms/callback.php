...
if ($cb_timestamp && $cb_from && $cb_text) {
	...
	_log("sender:" . $sms_sender . " receiver:" . $sms_receiver . " dt:" . $sms_datetime . " msg:[" . $message . "]", 3, "routesms incoming");
...
if ($cb_status && $cb_apimsgid) {
	...
	FROM " . _DB_PREF_ . "_tblSMSOutgoing," . _DB_PREF_ . "_gatewayRoutesms_apidata
	WHERE
	    " . _DB_PREF_ . "_tblSMSOutgoing.smslog_id=" . _DB_PREF_ . "_gatewayRoutesms_apidata.smslog_id AND
	    " . _DB_PREF_ . "_gatewayRoutesms_apidata.apimsgid='$cb_apimsgid'
    ";
