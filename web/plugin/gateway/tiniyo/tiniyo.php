...
include $core_config['apps_path']['plug'] . "/gateway/tiniyo/config.php";
...
switch (_OP_) {
	case "manage":
		...
		$content .= "
			<h2>" . _('Manage tiniyo') . "</h2>
			<form action=index.php?app=main&inc=gateway_tiniyo&op=manage_save method=post>
			" . _CSRF_FORM_ . "
			...
			<br />
			" . _('Notes') . ":<br />
			- " . _('Your callback URL should be accessible from tiniyo') . "<br />
			- " . _('tiniyo will push DLR and incoming SMS to your callback URL') . "<br />
			- " . _('tiniyo is a bulk SMS provider') . ", <a href=\"http://www.tiniyo.com\" target=\"_blank\">" . _('free credits are available for testing purposes') . "</a><br />";
	...
	case "manage_save":
		...
		header("Location: " . _u('index.php?app=main&inc=gateway_tiniyo&op=manage'));
		exit();
		break;
}
