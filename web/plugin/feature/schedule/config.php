...
$menu_config[$menutab][] = ["index.php?app=main&inc=feature_schedule&op=list", _('Schedule messages'), 1];

// plugin config
$plugin_config['schedule']['rules'] = [_('Once') => 0, _('Annually') => 1, _('Monthly') => 2, _('Weekly') => 3, _('Daily') => 4];
