...
$menu_config[$menutab][] = ["index.php?app=main&inc=feature_sms_subscribe&op=sms_subscribe_list", _('Manage subscribe')];
...
$plugin_config['sms_subscribe']['durations'] = [_('Unlimited') => 0, _('1 Day') => 1001, _('2 Days') => 1002, _('1 Week') => 101, _('2 Weeks') => 102, _('1 Month') => 1, _('6 Months') => 6];
