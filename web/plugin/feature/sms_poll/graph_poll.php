...
$myPicture->setFontProperties(array("FontName"=>$c_path."/lib/pChart/fonts/pf_arma_five.ttf","FontSize"=>8,"R"=>80,"G"=>80,"B"=>80));
...
$PieChart->draw3DPie(150,120,array("WriteValues"=>TRUE,"DataGapAngle"=>4,"DataGapRadius"=>5,"Border"=>TRUE));
/* Write the legend */
