...
switch (_OP_) {
	case "incoming":
		...
		$form_post_rules = [
			...
			[
				...
				'input' => $input_url,
				'help' => _('Example') . ': <br />http://example.com/handler.php?json={SANDBOX_PAYLOAD}&dt={SANDBOX_DATETIME}&s={SANDBOX_SENDER}&m={SANDBOX_MESSAGE}&r={SANDBOX_RECEIVER}&smsc={SANDBOX_SMSC}'
			],
		];
	...
	case "incoming_save":
		...
		// sandbox prefix
		$post_rules['insert_prefix'] = core_sanitize_keyword($_REQUEST['sandbox_prefix']);
