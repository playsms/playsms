...
switch ($op) {
	case 'list':
		...
		$output_serialize = $core_config['http_path']['base']."/index.php?app=webservices&ta=sms_board&keyword=VR&type=serialize";
		$output_json = $core_config['http_path']['base']."/index.php?app=webservices&ta=sms_board&keyword=VR&type=json";
		$output_xml = $core_config['http_path']['base']."/index.php?app=webservices&ta=sms_board&keyword=VR&type=xml";
		$output_rss091 = $core_config['http_path']['base']."/index.php?app=webservices&ta=sms_board&keyword=VR&type=feed&format=rss0.91";
		$output_rss10 = $core_config['http_path']['base']."/index.php?app=webservices&ta=sms_board&keyword=VR&type=feed&format=1.0";
		$output_rss20 = $core_config['http_path']['base']."/index.php?app=webservices&ta=sms_board&keyword=VR&type=feed&format=2.0";
		$output_atom = $core_config['http_path']['base']."/index.php?app=webservices&ta=sms_board&keyword=VR&type=feed&format=atom";
		$output_mbox = $core_config['http_path']['base']."/index.php?app=webservices&ta=sms_board&keyword=VR&type=feed&format=mbox";
		$output_html = $core_config['http_path']['base']."/index.php?app=webservices&ta=sms_board&keyword=VR&type=html";
		if ($err = $_SESSION['error_string']) {
			$content = "<div class=error_string>$err</div>";
		}
		$content .= "
			<h2>"._('Manage board')."</h2>
			<h3>"._('View board')." : ".$list[0]['board_keyword']."</h3>
