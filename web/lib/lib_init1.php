...
// action icons
$core_config['icon']['edit'] 		= "<img class=icon id=icon_edit src=\"".$http_path['themes']."/".$themes_module."/images/action_edit.gif\" alt=\""._('Edit')."\" title=\""._('Edit')."\">";
$core_config['icon']['delete'] 		= "<img class=icon id=icon_delete src=\"".$http_path['themes']."/".$themes_module."/images/action_delete.gif\" alt=\""._('Delete')."\" title=\""._('Delete')."\">";
$core_config['icon']['view'] 		= "<img class=icon id=icon_view src=\"".$http_path['themes']."/".$themes_module."/images/action_view.gif\" alt=\""._('View')."\" title=\""._('View')."\">";
$core_config['icon']['manage'] 		= "<img class=icon id=icon_manage src=\"".$http_path['themes']."/".$themes_module."/images/action_manage.gif\" alt=\""._('Manage')."\" title=\""._('Manage')."\">";
$core_config['icon']['reply'] 		= "<img class=icon id=icon_reply src=\"".$http_path['themes']."/".$themes_module."/images/action_reply.gif\" alt=\""._('Reply')."\" title=\""._('Reply')."\">";
$core_config['icon']['forward'] 	= "<img class=icon id=icon_forward src=\"".$http_path['themes']."/".$themes_module."/images/action_forward.gif\" alt=\""._('Forward')."\" title=\""._('Forward')."\">";
$core_config['icon']['export'] 		= "<img class=icon id=icon_export src=\"".$http_path['themes']."/".$themes_module."/images/action_export.gif\" alt=\""._('Export')."\" title=\""._('Export')."\">";
$core_config['icon']['import'] 		= "<img class=icon id=icon_import src=\"".$http_path['themes']."/".$themes_module."/images/action_import.gif\" alt=\""._('Import')."\" title=\""._('Import')."\">";
$core_config['icon']['publish'] 	= "<img class=icon id=icon_publish src=\"".$http_path['themes']."/".$themes_module."/images/action_publish.gif\" alt=\""._('Publish')."\" title=\""._('Publish')."\">";
$core_config['icon']['unpublish'] 	= "<img class=icon id=icon_unpublish src=\"".$http_path['themes']."/".$themes_module."/images/action_unpublish.gif\" alt=\""._('Unpublish')."\" title=\""._('Unpublish')."\">";
...
$core_config['icon']['phonebook'] 	= "<img class=icon id=icon_phonebook src=\"".$http_path['themes']."/".$themes_module."/images/action_phonebook.gif\" alt=\""._('Phonebook')."\" title=\""._('Phonebook')."\">";
$core_config['icon']['sendsms'] 	= "<img class=icon id=icon_sendsms src=\"".$http_path['themes']."/".$themes_module."/images/action_sendsms.gif\" alt=\""._('Send SMS')."\" title=\""._('Send SMS')."\">";
$core_config['icon']['calendar'] 	= "<img class=icon id=icon_calendar src=\"".$http_path['themes']."/".$themes_module."/images/action_calendar.gif\" alt=\""._('Pick date & time')."\" title=\""._('Pick date & time')."\">";
