	...
	case "all_incoming":
		...
		$content = "
			...
			<tr>
				...
				<th align=center width=25%>"._('From')."</th>
		...
		for ($j=0;$j<count($list);$j++) {
			...
			$c_message = "<div id=\"all_incoming_msg\">".$in_message."</div><div id=\"msg_label\">".$in_datetime."&nbsp;".$in_status."</div><div id=\"msg_option\">".$reply."&nbsp".$forward."</div>";
			$i--;
