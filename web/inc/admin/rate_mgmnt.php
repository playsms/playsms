...
switch ($op)
{
	...
	$content .= "
	    ...
	    <p>
	    <input type='button' value='"._('Add rate')."' onClick=\"javascript:linkto('menu.php?inc=rate_mgmnt&op=rate_add')\" class='button' />
	...
	while ($db_row = dba_fetch_array($db_result))
	{
	    ...
	    $action .= "<a href=\"javascript: ConfirmURL('"._('Are you sure you want to delete rate ?')." ("._('destination').": `".$db_row['dst']."`, "._('prefix').": `".$db_row['prefix']."`)','menu.php?inc=rate_mgmnt&op=rate_del&rateid=".$db_row['id']."')\">$icon_delete</a>";
	    $content .= "
    <tr>
