...
switch (_OP_) {
	case "all_outgoing":
		...
		$base_url = 'index.php?app=main&inc=all_outgoing&op=all_outgoing';
		...
		$content = "
			...
			<p>".$search['form']."</p>
			<form id=fm_all_outgoing name=fm_all_outgoing action=\"index.php?app=main&inc=all_outgoing&op=actions\" method=POST>
			"._CSRF_FORM_."
			<input type=hidden name=go value=delete>
			<div class=actions_box>
				<div class=pull-left>
					<a href=\""._u('index.php?app=main&inc=all_outgoing&op=actions&go=export')."\">".$icon_config['export']."</a>
				</div>
