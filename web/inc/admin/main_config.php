...
switch (_OP_) {
	case "main_config":
		...
		if ($core_config['main']['enable_logo']) {
			$selected1 = "selected";
		} else {
			$selected2 = "selected";
		};
		...
		$option_logo_replace_title = "<option value=\"1\" $selected1>" . _('yes') . "</option>";
		$option_logo_replace_title.= "<option value=\"0\" $selected2>" . _('no') . "</option>";
		$selected1 = "";
		$selected2 = "";
	...
	case "main_config_save":
		...
		$items = array(
			...
			'allow_custom_sender' => (int)$_POST['edit_allow_custom_sender'],
			'allow_custom_footer' => (int)$_POST['edit_allow_custom_footer']
		);
