...
switch ($op) {
	case "main_config":
		...
		<tbody>
		<tr>
			<td width='270'>"._('Website title')."</td><td><input type='text' size='50' name='edit_web_title' value=\"$web_title\"></td>
		</tr>
		<tr>
			<td>"._('Website email')."</td><td><input type='text' size='30' name='edit_email_service' value=\"$email_service\"></td>
		</tr>
		<tr>
			<td>"._('Forwarded email footer')."</td><td><input type='text' size='50' name='edit_email_footer' value=\"$email_footer\"></td>
		</tr>
		<tr>
