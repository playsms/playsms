...
switch ($op)
{
	...
	$content = "
	    ...
	    <tr>
	      ...
	      <th width=4 class=\"sorttable_nosort\"><input type=checkbox onclick=CheckUncheckAll(document.fm_outbox)></td>
	    </tr>
        </thead>
        <tbody>
	";
	...
	while ($db_row = dba_fetch_array($db_result))
	{
		...
		<tr>
		    ...
		    <a href=\"javascript: ConfirmURL('Are you sure you want to delete outgoing SMS to `$hide_p_dst`, number $i ?','menu.php?inc=get_status&op=del&slid=$current_slid')\">$icon_delete</a>
		  </td>
	...
	header ("Location: menu.php?inc=get_status&op=get_status&err=".urlencode("Selected outgoing SMS has been deleted"));	
	break;
}
